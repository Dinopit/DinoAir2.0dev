...
Fixed version that prevents Watchdog shutdown
"""
...
# CRITICAL: Disable Watchdog before importing GUI components
# This prevents the Watchdog from shutting down the test
...
class TestWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.log_output("Note: Watchdog is DISABLED for this test to prevent auto-shutdown.")
...
def main():
    ...
    print("=" * 50)
    print("⚠️  WATCHDOG DISABLED FOR TESTING")
    print("This prevents auto-shutdown after ~45 seconds")
    print("=" * 50)
